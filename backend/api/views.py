...
def upload_material(request):
    ...
    pdf_image_captions = create_documents_from_captions(captions)
    ...
    frame_rate = 1
    proccessed_videos = process_videos_in_directory(video_dir, frame_dir, frame_rate)
    ...
    documents = update_metadata(preproccessed_text)
